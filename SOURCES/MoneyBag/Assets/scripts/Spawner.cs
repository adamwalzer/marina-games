...
public class Spawner : MonoBehaviour 
{
	...
	public void startSpawn(LevelSettings settings_){
		...
		if(_settings.lightningBonus){
			StartCoroutine(spawnBonus(starPrefab));
		}
		if(_settings.moneybagBonus){
			StartCoroutine(spawnBonus(bagPrefab));
		}
	...
	IEnumerator spawnBonus(GameObject prefab){

...
public class Grid : MonoBehaviour {
	...
	********************************************************/
	...
	public bool IsLeft(int r,int c){
		...
		if(GettingObjId(r,c+1)==1 || GettingObjId(r,c+1)==2 ||GettingObjId(r,c+1)==3 || GettingObjId(r,c+1)==4 ||GettingObjId(r,c+1)==5||GettingObjId(r,c+1)==7)
		...
		if(GettingObjId(r,c+1)==0)
			if(GettingObjId(r,c-1)==0)
				if(GettingObjId(r-1,c)==0)
					if(GettingObjId(r-1,c-1)==0)
						if(GettingObjId(r-1,c+1)==0)
							if(GettingObjId(r,c)==1||GettingObjId(r,c)==2||GettingObjId(r,c)==3||GettingObjId(r,c)==4||GettingObjId(r,c)==5||GettingObjId(r,c)==7)
							returnvalue=true;
	...
	********************************************************/
	...
	public void FencePlacement(int r,int c,GameObject s)
	{
		if( c>=0 && c<(DataFile.cols))
		{
		Debug.Log("checking col value "+c);
